                        ...
                        <div class="signup-form" style="margin-bottom: 30px;"><!--add product form-->
                            ...
                            <form action="{{ route('product.add') }}" method="post" enctype="multipart/form-data">
                                ...
                                <select name="status" id="">
                                    ...
                                    <option value="1" class="demo" {{ old('status') == 1 ? 'selected' : '' }}>
                                        Sale
                                    </option>
                                </select>
                                @error('status')
                                ...
                                <div class="percentage-input-container sale-price-container"
                                    ...
                                    <input type="number" name="sale_price" placeholder="0"
                                        style="width: 30%; margin-right: 5px;" value="{{ old('sale_price') }}">
                                    %
                                ...
                                <textarea name="detail" id="" cols="30" rows="10" placeholder="Detail">{{ old('detail') }}</textarea>
                                @error('detail')
                                    <b style="color: red">{{ $message }}</b>
                                @enderror
