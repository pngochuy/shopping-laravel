    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8 col-xlg-9 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('addCountry') }}" method="POST" class="form-horizontal form-material"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="col-md-12">Country Name <span
                                        style="font-weight: bold; color:red">(*)</span></label>
                                <div class="col-md-12">
                                    <input type="text" name="countryName" placeholder="country..."
                                        class="form-control form-control-line" value="{{ old('countryName') }}">
                                    @error('countryName')
