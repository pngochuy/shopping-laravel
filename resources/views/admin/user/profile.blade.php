        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30">
                            <img src="{{ asset('upload/user/avatar/' . $currentUser->avatar) }}" class="rounded-circle"
                                width="150" />
                    ...
                    <div class="card-body"> <small class="text-muted">Email address </small>
                        <h6>{{ $currentUser->email }}</h6> <small class="text-muted p-t-30 db">Phone</small>
                        <h6>{{ $currentUser->phone }}</h6> <small class="text-muted p-t-30 db">Address</small>
                        <h6>71 Pilgrim Avenue Chevy Chase, MD 20815</h6>
                        <small class="text-muted p-t-30 db">Country</small>
                        <h6>
                            @foreach ($countryList as $country)
                                @if ($currentUser->id_country == $country->id)
                                    {{ $country->country }}
                                @endif
                            @endforeach
                        </h6>
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile') }}" method="POST" class="form-horizontal form-material"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="email" name="email" placeholder="johnathan@admin.com"
                                        ...
                                        value="{{ old('email', $currentUser->email) }}" readonly>
                                    @error('email')
                                        <b style="color: red">{{ $message }}</b>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="file" name="avatar" class="form-control" accept="image/*"
                                        value="{{ old('avatar', $currentUser->avatar) }}">
                                    @error('avatar')
                                        <b style="color: red">{{ $message }}</b>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control form-control-line" name="id_country">
                                        ...
                                        @foreach ($countryList as $country)
                                            <option @if ($currentUser->id_country == $country->id) {{ 'selected' }} @endif
